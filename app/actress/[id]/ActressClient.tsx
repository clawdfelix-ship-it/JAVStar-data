...
export default function ActressClient({ initialData, actressId }: ActressClientProps) {
  ...
  return (
    <div className="min-h-screen bg-bg-secondary">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 border-b bg-white/70 backdrop-blur-xl backdrop-saturate-150 supports-[backdrop-filter]:bg-white/60" style={{borderColor:'rgba(var(--color-sakura-gray),0.6)'}}>
                            ...
                            <button
                              onClick={() => {
                                const shareUrl = 'https://twitter.com/intent/tweet?url=' + 
                                  ...
                                  '&text=' + encodeURIComponent(`${actress.name_ja} - JCHING CALENDAR`);
